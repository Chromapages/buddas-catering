    ...
    <section className="bg-cream py-16 md:py-20 lg:py-24">
      <div className="max-w-6xl mx-auto px-4 md:px-6">
        <div className="text-center mb-10 md:mb-12 px-4 md:px-0">
          ...
          <p className="mt-4 text-brown/65 max-w-xl mx-auto text-base font-medium">
        ...
        <div className="grid grid-cols-2 sm:grid-cols-4 gap-3 md:gap-4 max-w-3xl mx-auto">
          {ORGS.map(({ icon: Icon, label }) => (
            <div
              key={label}
              className="flex flex-col items-center gap-3 bg-white rounded-2xl border border-gray-border px-3 md:px-4 py-4 md:py-6 hover:border-teal-base/40 hover:shadow-sm transition-all group"
            >
              <div className="w-10 md:w-12 h-10 md:h-12 rounded-xl bg-teal-base/10 flex items-center justify-center group-hover:bg-teal-base/20 transition-colors">
                <Icon className="w-5 h-5 text-teal-dark" />
              </div>
              <span className="text-sm font-bold text-brown text-center leading-tight">
                {label}
              </span>
            </div>
          ))}
